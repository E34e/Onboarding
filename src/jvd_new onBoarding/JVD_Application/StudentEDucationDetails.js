  ...
  const formIk = useFormik({
    ...
    validationSchema: eduDEtailsValidation,
      ...
      function clrCap()
        ...
        // const [showIvalue,setIvalue]=useState("");
        // function getDetailsFunc(e){
        //       let iUrl ="http://172.16.150.61:8302/jnbap/getCetDetails" + showIvalue;
        //       axios.get(iUrl).then((response) => {
        //        alert(JSON.stringify(response.data))
        //         setList(response.data[0].hostelName);
        //   });}
        //   function fieldSetFuncn(){
        //       formik.setFieldValue("hostelName",showIvalue)
        //     }
        //     useEffect(()=> {
        //       fieldSetFuncn();
        //     },[showIvalue]
